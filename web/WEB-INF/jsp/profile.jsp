...
<div class="wrap">
            ...
            <div>
                ...
                <select name="localeToSet">
                    <c:if test="${not empty defaultLocale}">
                        <option value="${defaultLocale}">${defaultLocale}[Default]</option>
                    </c:if>
    ...
    <c:if test="${fn:length(accounts) == 0}">
        <div> No such accounts [non locale]</div>
    </c:if>
    <c:if test="${fn:length(accounts) > 0}">
        <div class="card my-5">
            <div class="card-body">
                <div class="btn-group">
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=numberUp'">numberup
                    </button>
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=numberDown'">numberdown
                    </button>
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=nameUp'"> nameUp
                    </button>
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=nameDown'">nameDown
                    </button>
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=balanceUp'"> balanceUp
                    </button>
                    <button class="btn btn-lg btn-light" style="display:inline;"
                            onclick="location.href='/controller?command=userAccount&sort=balanceDown'">balanceDown
                    </button>
                </div>
